...
template: splash
hero:
  tagline: Strongly typed, ultra-light, blazing fast -- runs on any JavaScript runtime.
  image:
...
[See full comparison →](/guides/comparison/)
...
<Aside type="tip">
  Stoma is used in production to power high-performance, multi-tenant API gateways.
</Aside>
