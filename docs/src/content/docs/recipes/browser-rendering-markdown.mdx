...
<Aside type="tip">
  For a full, high-quality markdown extraction implementation, see the [examples/cloudflare-worker/src/index.ts](https://github.com/HomeGrower-club/stoma/blob/main/examples/cloudflare-worker/src/index.ts) file in the repository.
</Aside>
