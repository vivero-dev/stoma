...
| Bundle size | Lightweight (Hono core) | 100MB+ image | 80MB+ binary | 50MB+ node_modules |
...
| Plugin ecosystem | npm (any Hono middleware) | Kong Hub (large ecosystem) | Community plugins | npm |
