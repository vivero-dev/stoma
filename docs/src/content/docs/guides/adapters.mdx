...
2. **Create the adapter**:
    ...
    import { Pool } from "pg";
    import { createGateway } from "@vivero/stoma";
    import { postgresAdapter } from "@vivero/stoma/adapters/postgres";
...
const rlStore = adapter.rateLimitStore as import("@vivero/stoma/adapters/postgres").PostgresRateLimitStore;
const cacheStore = adapter.cacheStore as import("@vivero/stoma/adapters/postgres").PostgresCacheStore;
