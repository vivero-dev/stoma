...
<Code theme="github-dark-default" code={authRoutes} lang="ts" title="routes/auth.ts" />
<Code theme="github-dark-default" code={apiRoutes} lang="ts" title="routes/api.ts" />
<Code theme="github-dark-default" code={configGateway} lang="ts" title="gateway.ts" />
