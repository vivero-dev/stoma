...
<Code theme="github-dark-default" code={basicCaching} lang="ts" title="examples/caching/basic.ts" />
...
```typescript
import { createGateway, cache, cors } from "@vivero/stoma";
...
<Code theme="github-dark-default" code={advancedCaching} lang="ts" title="examples/caching/advanced.ts" />
