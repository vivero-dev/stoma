...
import { safeCall } from "@vivero/stoma/sdk";
import { getGatewayContext } from "@vivero/stoma";
...
export const COUNTER_CODE = `import { createGateway, definePolicy, Priority } from "@vivero/stoma";
import type { GatewayAdapter } from "@vivero/stoma";
import { getGatewayContext } from "@vivero/stoma";
import { safeCall } from "@vivero/stoma/sdk";
...
<Aside type="tip">
For testing, use `TestAdapter` from `@vivero/stoma/adapters`. It
...
- **Deno, Bun, Node** -- runtime-specific adapters available at
  `@vivero/stoma/adapters/deno`, `@vivero/stoma/adapters/bun`,
  and `@vivero/stoma/adapters/node`.
