...
```typescript
import { scope } from "@vivero/stoma";
```
...
<Code theme="github-dark-default" code={routeScopes} lang="ts" title="examples/route-scopes/gateway.ts" />
<EditorLink code={routeScopes} title="Route Scopes" />
